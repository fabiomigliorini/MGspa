...
<template>
  <q-page class="q-pa-md">
    <div style="max-width: 1086px; margin: auto">
      ...
      <!-- Classificação: os parâmetros que calculam o desconto do recebimento -->
      <q-card bordered flat class="overflow-hidden">
        <q-item clickable v-ripple :to="{ name: 'cultura-desconto', params: { codcultura } }">
          ...
          <q-item-section>
            <q-item-label class="text-subtitle1">Classificação</q-item-label>
            <q-item-label caption
              >Umidade, impureza, avariados — tolerâncias e fórmula</q-item-label
            >
          </q-item-section>
          <q-item-section side>
