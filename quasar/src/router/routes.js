...
export default [
  ...
  { path: '/estoque-saldo-conferencia/listagem/:codestoquelocal/:codmarca/:fiscal/:conferenciaperiodica/:data', component: () => import('components/views/estoque-saldo-conferencia/Listagem/') },
