<template>
  <q-card class="no-shadow" bordered>
    ...
    <q-card-section class="q-pa-none">
      <q-table square class="no-shadow" title="Notas Lançadas" @row-click="linkslancadas" :rows="valuelancadas"
        :columns="columns" :loading="loading" no-data-label="Nenhuma nota lançada encontrada." :filter="filter"
