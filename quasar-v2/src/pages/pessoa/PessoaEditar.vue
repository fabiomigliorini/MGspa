<template>
  <div class="q-pa-md q-gutter-sm" style="text-align: left; padding-top: 20px;">
     ...
     <q-btn :to="{name: 'pessoaview'}" color="grey" icon="visibility" label="Detalhes"   dense flat/>
  </div>
  ...
  <div class="q-pa-md q-gutter-sm" >
     ...
     <q-input filled v-model="form.cnpj" label="CNPJ/CPF" v-if="form.fisica == true" mask="###.###.###-##" unmasked-value dense/>
  ...
  <div class="q-pa-md q-gutter-sm" padding>
   <q-input v-if="form.cobrancaendereco == false" v-model="form.cepcobranca" filled  label="CEP" mask="#####-###" unmasked-value dense/> 
     ...
     <q-input v-if="form.cobrancaendereco == false" filled v-model="form.complementocobranca" label="Complemento" dense/>
  ...
  <q-separator></q-separator>
  <div class="q-pa-md q-gutter-sm">
    <q-btn :to="{name: 'pessoaview', params: {id: route.params.id} }"  color="red" label="Cancelar"   dense flat/>
     ...
     const ceperror = ref(false)
      ...
      const onSubmit = async () => {
        ...
        try {
          ...
          const {data} = await api.put('v1/pessoa/' + route.params.id, form.value)
