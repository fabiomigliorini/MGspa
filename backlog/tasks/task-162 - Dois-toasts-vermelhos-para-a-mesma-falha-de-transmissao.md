...
Corrigido: o composable marca o erro com `notificado = true` ao rejeitar, e transmitirXml faz o mesmo no erro de cStat recusado. O emitir() e o transmitirNfe() so notificam o que NAO passou pelo composable (criar XML, imprimir, abrir DANFE).
