...
Os 4 blocos (Caminhao, Pesagem, Classificacao, Origem/Destino) estao implementados; falta so a limpeza do FAB cinza 'salvar sem avancar' e decidir onde fica a Observacao. Consolidada em 2026-09-23: era esta task mais as subtasks TASK-171.1 a 171.5 (arquivadas), agora criterios de aceite aqui.
...
Eram os arquivos TASK-171.1 a 171.5 (antes 146.1 a 146.5, de outra maquina).
