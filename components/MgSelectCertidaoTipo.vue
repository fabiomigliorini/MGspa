...
// Carrega TUDO de v1/select/certidao-tipo, cacheia, filtra no front, refresh no append.
const props = defineProps({
  modelValue: { type: [Number, String], default: null },
  label: { type: String, default: 'Tipo de Certidão' },
...
const ENTITY = 'certidaoTipo'
const ENDPOINT = 'v1/select/certidao-tipo'
