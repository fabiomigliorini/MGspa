...
// Carrega TUDO uma vez de v1/select/tipo-movimento-titulo, cacheia (lista + byId no store
...
const ENTITY = 'tipoMovimentoTitulo'
const ENDPOINT = 'v1/select/tipo-movimento-titulo'
