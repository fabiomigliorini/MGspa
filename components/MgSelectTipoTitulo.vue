...
// Carrega TUDO uma vez de v1/select/tipo-titulo, cacheia (lista + byId no store
...
const props = defineProps({
  ...
  label: { type: String, default: 'Tipo de Título' },
...
const ENTITY = 'tipoTitulo'
const ENDPOINT = 'v1/select/tipo-titulo'
