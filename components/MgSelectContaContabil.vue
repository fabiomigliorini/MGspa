...
// cacheia por id; resolve o valor atual por v1/select/conta-contabil/{id}.
const props = defineProps({
  modelValue: { type: [Number, String], default: null },
  label: { type: String, default: 'Conta Contábil' },
...
const ENTITY = 'contaContabil'
const ENDPOINT = 'v1/select/conta-contabil'
const PER_PAGE = 20
...
async function buscar(busca, page) {
  const { data } = await api.get(ENDPOINT, { params: { busca, page } })
