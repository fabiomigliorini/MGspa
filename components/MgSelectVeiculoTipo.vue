...
// Carrega TUDO uma vez de v1/select/veiculo-tipo, cacheia (lista + byId no store
...
const props = defineProps({
  ...
  label: { type: String, default: 'Tipo de Veículo' },
...
const ENTITY = 'veiculoTipo'
const ENDPOINT = 'v1/select/veiculo-tipo'
