...
// Carrega TUDO uma vez de v1/select/grau-instrucao, cacheia (lista + byId no store
// compartilhado) e filtra no FRONT ao digitar. clearable é opcional (default false).
const props = defineProps({
  modelValue: { type: [Number, String], default: null },
  label: { type: String, default: 'Grau de Instrução' },
...
const ENTITY = 'grauInstrucao'
const ENDPOINT = 'v1/select/grau-instrucao'
