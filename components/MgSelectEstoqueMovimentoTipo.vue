...
// Carrega TUDO uma vez de v1/select/estoque-movimento-tipo, cacheia (lista + byId no store
...
const props = defineProps({
  ...
  label: { type: String, default: 'Tipo de Movimento' },
...
const ENTITY = 'estoqueMovimentoTipo'
const ENDPOINT = 'v1/select/estoque-movimento-tipo'
