...
import { forcarAtualizacao } from './pwaAtualizacao'

const props = defineProps({
  auth: { type: Object, required: true },
})

// A tarja de nova versão mora no MgBannerNovaVersao, montado no App.vue de cada
// app — aqui fica só o escape hatch manual do menu.
