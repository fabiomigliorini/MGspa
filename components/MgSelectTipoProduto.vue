...
// Carrega TUDO uma vez de v1/select/tipo-produto, cacheia (lista + byId no store
...
const props = defineProps({
  ...
  label: { type: String, default: 'Tipo de Produto' },
...
const ENTITY = 'tipoProduto'
const ENDPOINT = 'v1/select/tipo-produto'
