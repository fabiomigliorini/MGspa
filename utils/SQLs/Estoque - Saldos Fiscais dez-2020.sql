...
create materialized view mvwestoque2020  as 
	...
	inner join tblestoquemes em on (em.codestoquemes = (select em2.codestoquemes from tblestoquemes em2 where em2.codestoquesaldo = es.codestoquesaldo and em2.mes <= '2020-12-31' order by mes desc limit 1))
