...
inner join tblestoquelocalprodutovariacao elpv on (elpv.codprodutovariacao = pv.codprodutovariacao and elpv.codestoquelocal = 101001) -- CENTRO
...
and (ultimaconferencia < '2017-07-26' or ultimaconferencia is null)
--and coalesce(pv.codmarca, p.codmarca) = 29 -- ACRILEX
