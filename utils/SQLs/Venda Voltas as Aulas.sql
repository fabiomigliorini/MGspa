...
from
    ...
    and tblprodutobarra.codproduto in (select tblproduto.codproduto from tblproduto where tblproduto.codmarca = 129) -- CODIGO DA MARCA
...
full join (
    ...
    where p.codmarca = 129 -- CODIGO DA MARCA
