...
values (210, '2017-10-20', null, '2017-10-20 11:41', 1)
...
select codcheque, 2110, '2017-10-20 11:41', 1
from tblcheque where cmc7 in (
'<00142703<0188505415>346004378835:',
'<00142703<0188502695>361004389286:',
'<00142705<0188533115>328011729135:',
'<10432636<0189007985>100102026549:',
'<23709535<0180002285>836900023643:'
)

update tblcheque set indstatus = 2 where indstatus = 1 and codcheque in (select crc.codcheque from tblchequerepassecheque crc where codchequerepasse = 2110)
...
update tblchequerepasse set data = '2017-10-20', criacao = '2017-10-20 11:41' where codchequerepasse = 2100
update tblchequerepassecheque set criacao = '2017-10-20 11:41' where codchequerepasse = 2100
