...
module.exports = configure(function (ctx) {
  return {
    ...
    env: {
      API_URL: ctx.dev
         ? 'http://api-mgspa-dev.mgpapelaria.com.br/api/'
         : 'https://api-mgspa.mgpapelaria.com.br/api/',

         MGSIS_URL: ctx.dev
         ? 'http://sistema-dev.mgpapelaria.com.br/MGsis/'
         : 'https://sistema.mgpapelaria.com.br/MGsis/',

         OAUTH_URL: ctx.dev
         ? 'http://api-mgspa-dev.mgpapelaria.com.br/api/quasar'
         : 'https://api-mgspa.mgpapelaria.com.br/api/quasar',
