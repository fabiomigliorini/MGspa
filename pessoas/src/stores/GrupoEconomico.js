  ...
  actions: {
    ...
    async removerdoGrupo(codpessoa, codgrupoeconomico) {
      const ret = await api.delete(
        'v1/pessoa/' + codpessoa + '/grupoeconomico/' + codgrupoeconomico + '/removerdogrupo',
      )
      return ret
    },
    ...
    async getNegocios(codgrupoeconomico, codpessoa) {
      const ret = await api.get('v1/grupo-economico/' + codgrupoeconomico + '/negocios', {
        params: codpessoa,
      })
      return ret
    },
    ...
    async getTopProdutos(codgrupoeconomico, codpessoa) {
      const ret = await api.get('v1/grupo-economico/' + codgrupoeconomico + '/top-produtos', {
        params: codpessoa,
      })
      return ret
    },
