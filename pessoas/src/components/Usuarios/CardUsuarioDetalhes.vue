      ...
      <q-item>
        ...
        <q-item-label header>
          <q-item-label>
            ...
            >
              <q-tooltip transition-show="scale" transition-hide="scale"> Inativar </q-tooltip>
            </q-btn>
            ...
            >
              <q-tooltip transition-show="scale" transition-hide="scale"> Ativar </q-tooltip>
            </q-btn>
          ...
          <q-item-label v-if="sUsuario.detalheUsuarios.inativo"> Inativo </q-item-label>
