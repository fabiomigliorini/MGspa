  ...
  <q-form @submit="submit()">
    ...
    <q-card bordered class="q-ma-md">
      <q-card-section>
        ...
        <q-item v-else>
          <q-item-section avatar>
            <q-avatar color="primary" class="" size="70px" text-color="white"> N </q-avatar>
          </q-item-section>
          <q-item-label header>
            <q-item-label>
              <span class="text-h4 text-weight-bold"> Novo Usuário </span>
            </q-item-label>
          </q-item-label>
        </q-item>
      ...
      <q-card-section class="q-px-md q-py-none">
        <div class="text-subtitle2 q-mb-md">Permissões</div>
