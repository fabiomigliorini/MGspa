...
<template>
  ...
  <q-dialog v-model="dialogUpload">
    <q-card bordered flat style="width: 600px; max-width: 90vw">
      ...
      <q-card-actions align="right" class="text-primary">
        ...
        <q-btn flat label="Enviar" @click="upload" :disable="!canUpload" :loading="isUploading" />
      </q-card-actions>
    </q-card>
  </q-dialog>
  ...
  <q-card bordered flat>
    ...
    <template v-if="filtro === 'ativos'">
        ...
        <template v-for="arquivo in arquivos.ativos" :key="arquivo.nome">
          ...
          <q-item>
            <q-item-section avatar>
              <q-btn round flat :icon="icone(arquivo)" color="primary" @click="abrir(arquivo)" />
            </q-item-section>
            ...
            <q-item-section class="cursor-pointer" @click="abrir(arquivo)">
              ...
              <q-item-label caption>
                {{ fileSize(arquivo.size) }} | {{ formataFromNow(arquivo.lastModified) }} |
      ...
      <div v-else class="q-pa-md text-center text-grey">Nenhum anexo</div>
    </template>
    ...
    <template v-if="filtro === 'inativos'">
      ...
      <div v-else class="q-pa-md text-center text-grey">Lixeira vazia</div>
    </template>
  </q-card>
</template>
