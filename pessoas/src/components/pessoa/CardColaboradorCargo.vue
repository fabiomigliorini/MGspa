        ...
        <q-card style="min-width: 350px">
            <q-form @submit="salvar()">
                ...
                <q-card-section>
                    ...
                    <select-cargo v-model="modelColaboradorCargo.codcargo" :permite-adicionar="true" reactive-rules :rules="[
                        val => val !== null && val !== '' && val !== undefined || 'Cargo Obrigatório',
                    ]"></select-cargo>

                    <select-filial v-model="modelColaboradorCargo.codfilial" reactive-rules :rules="[
                    ...
                    <div class="row">
                        <div class="col-6">
                            <q-input outlined v-model="modelColaboradorCargo.inicio" mask="##/##/####" label="Início"
                                :rules="[validaDataValida, validaInicio, validaObrigatorio]" input-class="text-center">

                                <template v-slot:append>
                                    <q-icon name="event" class="cursor-pointer">
                                        <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                                            <q-date v-model="modelColaboradorCargo.inicio" :locale="brasil"
                                                mask="DD/MM/YYYY">
                        ...
                        <div class="col-6">
                            <q-input outlined v-model="modelColaboradorCargo.fim" class="q-pl-md" mask="##/##/####"
                                label="Fim" :rules="[validaDataValida, validaFim]" input-class="text-center">

                                <template v-slot:append>
                                    <q-icon name="event" class="cursor-pointer">
                                        <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                                            <q-date v-model="modelColaboradorCargo.fim" :locale="brasil" mask="DD/MM/YYYY">
                                                <div class="row items-center justify-end">
                                                    <q-btn v-close-popup label="Fechar" color="primary" flat />
                                                </div>
                                            </q-date>
                        ...
                        <div class="col-6">
                            <q-input outlined v-model="modelColaboradorCargo.comissaoloja" input-class="text-right"
                                label="Comissão Loja">
                                <template v-slot:append>
                                    %
                                </template>
                        ...
                        <div class="col-6">
                            <q-input outlined v-model="modelColaboradorCargo.comissaovenda" input-class="text-right"
                                label="Comissão Venda" class="q-pl-md">
                                <template v-slot:append>
                                    %
                                </template>
                            </q-input>
                        ...
                        <div class="col-6">
                            <q-input outlined v-model="modelColaboradorCargo.comissaoxerox" input-class="text-right"
                                label="Comissão Xerox" class="q-pt-md">
                                <template v-slot:append>
                                    %
                                </template>
                            </q-input>
                        ...
                        <div class="col-6">
                            <q-input outlined v-model="modelColaboradorCargo.gratificacao" input-class="text-left"
                                label="Gratificação" class="q-pl-md q-pt-md">
                    ...
                    <q-input outlined autogrow bordeless v-model="modelColaboradorCargo.observacoes" class="q-pt-md"
    ...
    methods: {
        ...
        preencheCargo(colaborador) {
            ...
            if (colaborador.ColaboradorCargo.length > 0) {
                ...
                this.modelColaboradorCargo = {
                    inicio: moment(colaborador.contratacao, 'YYYY-MM-DD').format('DD/MM/YYYY'),
                    codcolaborador: colaborador.codcolaborador
                }
            }
        ...
        async excluir(colaboradorCargo) {
            this.$q.dialog({
                ...
                try {
                    const ret = await this.sColaborador.deleteColaboradorCargo(colaboradorCargo)
                    this.$q.notify({
                        color: 'green-5',
                        textColor: 'white',
                        icon: 'done',
