...
import { formataCpf, formataCnpj, formataTelefone } from '@components/formatters'
...
<template>
  <router-link :to="'/pessoa/' + listagempessoas.codpessoa" class="full-height link-card">
    <q-card bordered flat class="cursor-pointer full-height q-pb-md">
      <!-- BADGE INATIVO -->
      <q-badge v-if="listagempessoas.inativo" color="red" floating label="Inativo" />
