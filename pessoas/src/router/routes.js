...
const routes = [
  ...
  // ROTAS AUTENTICADAS
  {
    ...
    children: [
      ...
      { path: '/usuarios/:codusuario/editar', name: 'usuariosedit', component: () => import('pages/usuarios/usuarioseditar') },
      { path: '/perfil', name: 'perfil', component: () => import('pages/usuarios/perfil') },
      { path: '/usuarios/novo', name: 'usuarionovo', component: () => import('pages/usuarios/novo') },


      { path: '/grupo-usuarios', name:'grupousuarios', component: () => import('pages/grupo-usuario/Index.vue') },
      { path: '/grupo-usuarios/:codgrupousuario', name: 'grupousuarioview', component: () => import('pages/grupo-usuario/grupoUsuarioView') },
