...
const indicadoresLinha = (pc) => {
  ...
  const codsComRubrica = new Set(rubricas.filter((r) => r.codindicador).map((r) => r.codindicador))
    ...
    <template v-if="!loading && colaborador">
      ...
      <div class="q-pa-md">
        ...
        <template v-if="gestor && equipeAgrupada.length > 0">
          ...
          <div class="text-overline text-grey-9 q-mb-md">EQUIPE DO SETOR</div>
          ...
          >
            ...
            <q-markup-table flat separator="horizontal">
              ...
              <tbody>
                <template v-for="pc in grupo.colaboradores" :key="pc.codperiodocolaborador">
                  <tr
                  ...
                  >
                    <td
                      v-if="idx === 0"
                      :rowspan="indicadoresLinha(pc).length"
