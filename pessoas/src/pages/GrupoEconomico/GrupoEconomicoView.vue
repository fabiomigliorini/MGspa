...
const pessoasOrdenadas = computed(() =>
  [...pessoasGrupo.value].sort((a, b) => (a.fantasia || '').localeCompare(b.fantasia || '')),
)
...
const salvar = async () => {
  try {
    const ret = await sGrupoEconomico.salvarGrupoEconomico(route.params.id, model.value)
    if (ret.data.data) {
        ...
        >
          ...
          <q-item class="q-pt-lg q-pb-sm">
            <q-item-section avatar>
              <q-avatar color="primary" text-color="white" size="80px" icon="groups" />
            </q-item-section>
            <q-item-section>
              <div
              ...
              <div v-if="grupoEconomico.inativo" class="text-caption text-red-14">
            ...
            <q-item-section side v-if="user.temPermissao('Publico')">
              <div class="row">
                ...
                <q-btn flat round dense icon="delete" color="grey-7" @click="excluir()">
          ...
          <div class="row q-col-gutter-md q-py-md">
            ...
            <!-- TITULOS ABERTOS -->
            <div class="col-12">
              <tabela-titulos-abertos :codgrupoeconomico="grupoEconomico.codgrupoeconomico" />
            </div>
