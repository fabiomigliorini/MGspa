                            ...
                            <div class="row">
                                        ...
                                        <q-item-section top>
                                            <q-item-label v-if="sUsuario.detalheUsuarios.Pessoa">
                                                ...
                                                <q-btn flat dense :label="sUsuario.detalheUsuarios.Pessoa.pessoa"
                                                    :to="'/pessoa/' + sUsuario.detalheUsuarios.Pessoa.codpessoa"
                                                    target="_blank" />
                                            </q-item-label>
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <q-item>
                                        ...
                                        <q-item-section top>
                                            <q-item-label>
                                                <span v-if="sUsuario.detalheUsuarios.impressoratermica">{{
                                            sUsuario.detalheUsuarios.impressoratermica
                                        }}</span>
                                                <span v-else>Vazio</span>
                                            </q-item-label>
                                            <q-item-label caption>
                            ...
                            <div class="row">
                                <!-- <div class="col-xs-12 col-sm-12">
                                    <q-item>
                                        ...
                                        <q-item-section top>
                                            <q-item-label>
                                                <q-input outlined v-model="modelPerfilUsuario.usuario"
                                                    label="Usuario" />
                                            </q-item-label>
                                        </q-item-section>
                                    </q-item>
