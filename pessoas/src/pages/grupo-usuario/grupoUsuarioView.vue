    ...
    <template #content v-if="user.verificaPermissaoUsuario('Administrador')">
      ...
      >
        <q-item class="q-pt-lg q-pb-sm">
          <q-item-section avatar>
            <q-avatar color="grey-8" text-color="grey-4" size="80px">
              {{ sGrupoUsuario.detalheGrupoUsuarios.grupousuario?.slice(0, 1)?.toUpperCase() }}
            </q-avatar>
          </q-item-section>
          <q-item-section>
        ...
        <div class="row q-col-gutter-md q-pa-md q-pt-none">
          ...
          <div class="col-12">
            <q-card bordered flat>
              <q-card-section class="text-grey-9 text-overline row items-center">
                DETALHES DO GRUPO
                <q-space />
                <q-btn flat round dense size="sm" color="grey-7" icon="edit" @click="editar()">
              ...
              <q-list>
                <q-item>
                  ...
                  <q-item-section>
                    ...
                    <q-item-label class="text-caption" v-else> Sem Observações </q-item-label>
          ...
          <div class="col-12">
            <q-card bordered flat>
              <q-card-section class="text-grey-9 text-overline"> USUÁRIOS DO GRUPO </q-card-section>

              <q-separator inset />

              <q-list v-if="sGrupoUsuario.detalheGrupoUsuarios.Usuarios?.length">
                <template
                  v-for="(usuariosDoGrupo, index) in sGrupoUsuario.detalheGrupoUsuarios.Usuarios"
                ...
                >
                  ...
                  <q-item :to="'/usuarios/' + usuariosDoGrupo.codusuario">
                    ...
                    <q-item-section>
                      ...
                      <q-item-label caption v-if="usuariosDoGrupo.filiais?.length">
                        <template
              ...
              <div v-else class="q-pa-md text-center text-grey">Nenhum usuário neste grupo</div>
            </q-card>
          </div>
        </div>
      </div>
