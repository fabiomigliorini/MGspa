    ...
    if (
      ((t.Slim = (function () {
        ...
        ;(n.hasCanvasOption = function (t) {
          ...
          (n.transformCoordinates = function (t, e) {
            ...
            if (u && !(u > 8))
              switch (
                (u > 4 &&
                  ((t.width = a), (t.height = o), (t.style.width = h), (t.style.height = s)),
                u)
              ) {
                case 2:
        ...
        var m = function () {
          ...
          v = function () {
            return (
              null === g && (g = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream),
              g
            )
          },
          y = function (t) {
          ...
          At = function (t) {
            ...
            return (
              U('input', i) && !a && (r.input.image = Ct(t.input.image, t.input.type)),
              U('output', i) &&
                ((r.output = {
                ...
                'image/png' === r.output.type && (r.output.name = Q(r.input.name) + '.png')),
              U('actions', i) && (r.actions = kt(t.actions)),
              r
            )
          },
          Pt = function (t, i, n) {
            var o = t.output.image,
              ...
              r = A[n] || t.input.type
            'image/png' === r && (a = Q(t.input.name) + '.png'),
              o.toBlob(
                function (t) {
                  if ('msSaveBlob' in window.navigator)
                    return void window.navigator.msSaveBlob(t, a)
            ...
            var i = {
              ...
              ne: function (t, e, i, n) {
                ...
                return (
                  ...
                  (a = N(e.x, s, i.width)),
                  a - s < i.min.width && (a = s + i.min.width),
                  (u = n ? (a - s) * n : N(r - e.y, i.min.height, r)),
                  u < i.min.height && ((u = i.min.height), (a = s + u / n)),
                  (o = t.y - (u - t.height)),
                  (o < 0 || Math.round(r) > Math.round(i.height)) &&
              ...
              se: function (t, e, i, n) {
                ...
                return (
                  ...
                  (a = N(e.x, s, i.width)),
                  a - s < i.min.width && (a = s + i.min.width),
                  (u = n ? (a - s) * n : N(e.y - t.y, i.min.height, i.height - o)),
                  u < i.min.height && ((u = i.min.height), (a = s + u / n)),
                          ...
                          ;(this._element.className = 'slim-image-editor'),
                            ...
                            n.Buttons.forEach(function (e) {
                              var i = D(e),
                                ...
                                r = M(
                                  'button',
                                  'slim-editor-btn slim-btn-' + e + (a ? ' ' + a : ''),
                                )
                              ;(r.innerHTML = n),
                                (r.title = o || n),
                                (r.type = 'button'),
              ...
              t(this, i),
                ...
                this._options.forceSize &&
                  ('string' == typeof this._options.forceSize &&
                    (this._options.forceSize = Zt(this._options.forceSize)),
                  (this._options.ratio =
                ...
                'string' == typeof this._options.size &&
                  (this._options.size = Zt(this._options.size)),
                'string' == typeof this._options.minSize &&
                  (this._options.minSize = Zt(this._options.minSize)),
                ...
                [
                          ...
                          rt(s, h, function (t, e) {
                            ...
                            if (!vt(t, n._options.minSize))
                              return (
                                a(),
                                n._onImageTooSmall(),
                                void (i && i.apply(n, ['image-too-small']))
                              )
                  ...
                  },
                  {
                    ...
                    value: function (t, i, n, o) {
                      var a =
                          arguments.length > 4 && arguments[4] !== e
                            ? arguments[4]
                            : function (t) {},
