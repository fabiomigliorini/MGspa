...
module.exports = (function () {
  ...
  var snabbt = (function () {
    ...
    var snabbt = function (arg1, arg2, arg3) {
      ...
      if (elements.length !== undefined) {
        ...
        for (var i = 0, len = elements.length; i < len; ++i) {
          if (typeof arg2 == 'string')
            aggregateChainer.chainers.push(
              snabbtSingleElement(elements[i], arg2, preprocessOptions(arg3, i, len)),
            )
          else
            aggregateChainer.chainers.push(
              snabbtSingleElement(elements[i], preprocessOptions(arg2, i, len), arg3),
            )
        }
        return aggregateChainer
      } else {
        ...
        else return snabbtSingleElement(elements, preprocessOptions(arg2, 0, 1), arg3)
      }
    }
  ...
  var send = function send(url) {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4 && xhr.status >= 200 && xhr.status < 300) {
        ...
        if (
          (typeof _obj === 'undefined' ? 'undefined' : _typeof(_obj)) === 'object' &&
          _obj.status === 'failure'
        ) {
          err(_obj.message)
          return
  ...
  var downloadCanvas = function downloadCanvas(data, jpegCompression, forcedType) {
    ...
    canvas.toBlob(
      ...
      type,
      typeof jpegCompression === 'number' ? jpegCompression / 100 : undefined,
    )
  }
        ...
        [
          {
            ...
            value: function _init() {
              ...
              ImageEditor.Buttons.forEach(function (c) {
                ...
                var btn = create(
                  'button',
                  'slim-editor-btn slim-btn-' + c + (className ? ' ' + className : ''),
                )
                btn.innerHTML = label
          ...
          },
          {
            ...
            value: function _redrawCropper(rect) {
              ...
              this._cropper.minWidth =
                this._wrapperScale * this._options.minSize.width * this.scalar
              this._cropper.minHeight =
                this._wrapperScale * this._options.minSize.height * this.scalar
      ...
      [
        ...
        },
        {
          ...
          value: function setForceSize(dimensions, callback) {
            ...
            this.setRatio(
              this._options.forceSize.width + ':' + this._options.forceSize.height,
              callback,
            )
          },
        },
        ...
        },
        {
          ...
          value: function load(src) {
            ...
            if (typeof options === 'function') {
              ...
              // initial rotation
              this._initialRotation =
                options.rotation && options.rotation % 90 === 0 ? options.rotation : null
        ...
        },
        {
          ...
          value: function _init() {
            ...
            SlimButtons.filter(function (c) {
              ...
              var btn = create(
                'button',
                'slim-btn slim-btn-' + c + (className ? ' ' + className : ''),
              )
              btn.innerHTML = label
              btn.title = title
              btn.type = 'button'
        ...
        },
        {
          ...
          value: function _updateProgress(progress) {
            ...
            paths[0].setAttribute(
              'd',
              percentageArc(size * 0.5, size * 0.5, size * 0.5 - ringWidth, 0.9999),
            )

            paths[1].setAttribute(
              'd',
              percentageArc(size * 0.5, size * 0.5, size * 0.5 - ringWidth, progress),
            )
          },
        },
        {
        ...
        },
        {
          ...
          value: function _onImageTooSmall() {
            var error = this._options.statusImageTooSmall.replace(
              '$0',
              this._options.minSize.width + ' \xD7 ' + this._options.minSize.height,
            )
            this._throwError(error)
          },
        },
          ...
          value: function _applyTransforms(image, ready) {
            ...
            transformCanvas(image, actions, function (transformedImage) {
              ...
              if (
                ...
                (_this20._options.size && sizeDist(_this20._options.size, transformedImage) == 1)
              ) {
              ...
              if (
                ...
                _this20._options.minSize.width === _this20._options.size.width &&
                _this20._options.minSize.height === _this20._options.size.height &&
        ...
        },
        {
          ...
          value: function _cropAuto() {
            var callback =
              arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function (data) {}

            var isTilted = this._data.actions.rotation % 180 !== 0

            var rect = getAutoCropRect(
              isTilted ? this._data.input.image.height : this._data.input.image.width,
              isTilted ? this._data.input.image.width : this._data.input.image.height,
              this._ratio,
            )
        ...
        },
        {
          ...
          value: function _crop(x, y, width, height) {
            var callback =
              arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : function (data) {}
            var cropType =
              arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : CropType.MANUAL
            ...
            this.requestOutput(function (fileData, formData) {
              ...
              var onError = function onError(status) {
                ...
                if (status === 'file-too-big') {
                  ...
                  html = _this25._options.didReceiveServerError.apply(_this25, [
                    status,
              ...
              if (typeof _this25._options.service === 'string') {
                ...
                _this25._options.service.apply(_this25, [
                  _this25._options.serviceFormat === 'file' ? fileData : formData,
              ...
              function (imageData) {
                ...
                if (
                  ...
                  if (imageData.imageHead && _this26._options.copyImageHead) {
                    try {
                      output = new Blob(
                        [imageData.imageHead, loadImage.blobSlice.call(output, 20)],
                        {
  ...
  ;(function () {
    ...
    // status
    ;['ContentLength', 'UnknownResponse', 'UploadSuccess', 'LocalUrlProblem'].forEach(function (
      status,
    ) {
