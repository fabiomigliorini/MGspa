  ...
  ? (function () {
      ...
      var mergeOptions = function mergeOptions(base, additives) {
        ...
        for (key in base) {
          ...
          options[key] =
            typeof optionsToMerge[key] === 'undefined' ? base[key] : optionsToMerge[key]
        }
            ...
            },
            {
              ...
              value: function _init() {
                ...
                if (!this._input) {
                  ...
                  this._input.accept = 'image/jpeg,image/png,image/gif,image/bmp,text/plain'
                  // this._input.accept = "image/*,text/plain";
            ...
            },
            {
              ...
              value: function _load(resource, callback) {
                ...
                this._data.input.name =
                  options && options.name ? options.name : getFileNameByFile(file)
