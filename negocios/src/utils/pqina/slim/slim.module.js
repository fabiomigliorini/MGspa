  ...
  ? (function () {
      ...
      var snabbt = (function () {
        ...
        var clearOphanedEndStates = function () {
          completedAnimations = completedAnimations.filter(function (
            animation
          ) {
      ...
      var ImageExtensionsRegex =
        /(\.png|\.bmp|\.gif|\.jpg|\.jpe|\.jpg|\.jpeg)$/;
          ...
          [
            ...
            },
            {
              ...
              value: function _init() {
                ...
                this._output =
                  this._element.querySelector("input[type=hidden]");
            ...
            },
            {
              ...
              value: function _load(resource, callback) {
                ...
                if (isLowMemoryDevice()) {
                  internalCanvasSize =
                    this._options.internalCanvasSizeLowMemory;
                }
                ...
                getImageAsCanvas(
                  ...
                  function (image, meta) {
                    ...
                    var revealCanvas = function revealCanvas(done) {
                      // done, enable hopper
                      if (
                        _this18._imageHopper &&
                        _this18._options.dropReplace
                      ) {
                        _this18._imageHopper.enabled = true;
                      }
                  ...
                  function (transformedImage) {
                    ...
                    intro.onload = function () {
                      ...
                      if (_this22._options.ratio === "free") {
                        _this22._ratio =
                          intro.naturalHeight / intro.naturalWidth;
      ...
      (function () {
        ...
        // labels
        ["FileSize", "FileType", "NoSupport", "ImageTooSmall"].forEach(
          function (status) {
