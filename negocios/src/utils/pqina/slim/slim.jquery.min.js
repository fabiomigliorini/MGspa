    ...
    var s = (function () {
      ...
      var n = function (t, e, i) {
          ...
          if (
            ...
            n.isInstanceOf('Blob', t) || n.isInstanceOf('File', t))
          )
            (o = a = n.createObjectURL(t)), (r._type = t.type)
          else {
      ...
      ;(n.isInstanceOf = function (t, e) {
        ...
        (n.scale = function (t, i) {
          ...
          if (
            (v &&
              ((i = n.getTransformedOptions(t, i)),
              (c = i.left || 0),
              (d = i.top || 0),
              i.sourceWidth
                ? ((l = i.sourceWidth), i.right !== e && i.left === e && (c = y - l - i.right))
                : (l = y - c - (i.right || 0)),
              i.sourceHeight
                ? ((p = i.sourceHeight), i.bottom !== e && i.top === e && (d = w - p - i.bottom))
                : (p = w - d - (i.bottom || 0)),
              (b = l),
              (k = p)),
            (r = i.maxWidth),
            ...
            v && r && s && i.crop
              ? ((b = r),
                ...
                (m = l / p - r / s),
                m < 0
                  ? ((p = (s * l) / r), i.top === e && i.bottom === e && (d = (w - p) / 2))
                  : m > 0 &&
                    ((l = (r * p) / s), i.left === e && i.right === e && (c = (y - l) / 2)))
              : ((i.contain || i.cover) && ((h = r = r || h), (u = s = s || u)),
                i.cover ? (a(), o()) : (o(), a())),
            v)
          ) {
            if (
              ...
              (_ = i.downsamplingRatio),
              _ > 0 && _ < 1 && b < l && k < p)
            )
              for (; l * _ > b; )
                (g.width = l * _),
                  (g.height = p * _),
                  n.renderImageToCanvas(g, t, c, d, l, p, 0, 0, g.width, g.height),
                  (l = g.width),
                  (p = g.height),
                  (t = document.createElement('canvas')),
                  (t.width = l),
                  (t.height = p),
                  n.renderImageToCanvas(t, g, 0, 0, l, p, 0, 0, l, p)
            return (
              (g.width = b),
              (g.height = k),
              n.transformCoordinates(g, i),
              n.renderImageToCanvas(g, t, c, d, l, p, 0, 0, b, k)
            )
          }
      ...
      ;(n.hasCanvasOption = function (t) {
        ...
        (n.transformCoordinates = function (t, e) {
          ...
          if (u && !(u > 8))
            switch (
              (u > 4 && ((t.width = a), (t.height = o), (t.style.width = h), (t.style.height = s)),
              u)
            ) {
              case 2:
              ...
              case 5:
                ...
                break
              case 6:
                i.rotate(0.5 * Math.PI), i.translate(0, -a)
                break
              case 7:
                i.rotate(0.5 * Math.PI), i.translate(o, -a), i.scale(-1, 1)
                break
              case 8:
                i.rotate(-0.5 * Math.PI), i.translate(-o, 0)
            }
        }),
        (n.getTransformedOptions = function (t, e) {
          var i,
          ...
          return (
            a.orientation > 4 &&
              ((i.maxWidth = a.maxHeight),
              (i.maxHeight = a.maxWidth),
              (i.minWidth = a.minHeight),
              (i.minHeight = a.minWidth),
              (i.sourceWidth = a.sourceHeight),
              (i.sourceHeight = a.sourceWidth)),
            i
          )
        })
      var h =
      ...
      ;(n.blobSlice =
              ...
              function (t) {
                ...
                if (65496 === p.getUint16(0)) {
                  ...
                  !i.disableImageHead &&
                    f > 6 &&
                    (l.slice
                      ? (r.imageHead = l.slice(0, f))
                      : (r.imageHead = new Uint8Array(l).subarray(0, f)))
                }
                e(r)
              },
              'readAsArrayBuffer',
        ...
        (n.getExifValue = function (t, e, i, o, a, r) {
          var s,
            h,
            u,
            l,
        ...
        (n.parseExifTags = function (t, e, i, n, o) {
          ...
          if (
            !(
              i + 6 > t.byteLength ||
              ((a = t.getUint16(i, n)), (r = i + 2 + 12 * a), r + 4 > t.byteLength)
            )
          ) {
          ...
          if (!a.disableExif) {
            ...
            if (
              ...
              42 === t.getUint16(u + 2, r) &&
                ...
                (s = n.parseExifTags(t, u, u + s, r, o)),
                s &&
                  !a.disableExifThumbnail &&
                  ((h = { exif: {} }),
                  (s = n.parseExifTags(t, u, u + s, r, h)),
                  h.exif[513] &&
                    (o.exif.Thumbnail = n.getExifThumbnail(t, u + h.exif[513], h.exif[514]))),
                o.exif[34665] &&
                  !a.disableExifSub &&
                  n.parseExifTags(t, u, u + o.exif[34665], r, o),
                o.exif[34853] &&
                  !a.disableExifGps &&
                  n.parseExifTags(t, u, u + o.exif[34853], r, o))
            }
          }
        }),
          ...
          var s = function (t, i, n) {
              ...
              if (o.length !== e) {
                for (
                  ...
                  'string' == typeof i
                    ? a.chainers.push(u(o[r], i, h(n, r, s)))
                    : a.chainers.push(u(o[r], h(i, r, s), n))
                return a
              }
            ...
            u = function (t, e, n) {
              function o(e) {
                if ((f.tick(e), f.updateElement(t), !f.isStopped()))
                  return f.completed()
                    ? void (a.loop > 1 && !f.isStopped()
                        ? ((a.loop -= 1), f.restart(), k(o))
                ...
                a.tick(i),
                  ...
                  a.completed()
                    ? (e.callback && e.callback(t),
                      e.loop && e.loop > 1 && (e.loop--, a.restart(), k(n)))
                    : k(n)
              }
              var o = y(e, j({}))
              e.movement = o
            ...
            y = function (t, e, i) {
              ...
              return (
                i &&
                  ...
                  (l = 'fromHeight'),
                  (p = 'fromOpacity')),
                (e.position = G(t[n], e.position)),
                (e.rotation = G(t[o], e.rotation)),
                (e.rotationPost = G(t[r], e.rotationPost)),
                (e.skew = G(t[a], e.skew)),
                (e.scale = G(t[s], e.scale)),
                (e.scalePost = G(t[h], e.scalePost)),
                (e.opacity = t[p]),
                (e.width = t[u]),
                (e.height = t[l]),
                e
            ...
            S = function (t) {
              ...
              var u,
                ...
                g = a / o
              return (
                (l = t.valueFeeder ? V(t.valueFeeder, i, n, h) : q(i, n, h)),
                {
                  stop: function () {
                    d = !0
                  },
            ...
            C = function (t) {
              ...
              return {
                ...
                updateMovement: function () {
                  var t = n.getValue()
                  a &&
                    ((l.position[0] = i.position[0] * t),
                    (l.position[1] = i.position[1] * t),
                    (l.position[2] = i.position[2] * t)),
                    r &&
                      ((l.rotation[0] = i.rotation[0] * t),
                      (l.rotation[1] = i.rotation[1] * t),
                      (l.rotation[2] = i.rotation[2] * t)),
                    s &&
                      ((l.rotationPost[0] = i.rotationPost[0] * t),
                      (l.rotationPost[1] = i.rotationPost[1] * t),
                      (l.rotationPost[2] = i.rotationPost[2] * t)),
                    h && ((l.scale[0] = 1 + i.scale[0] * t), (l.scale[1] = 1 + i.scale[1] * t)),
                    u && ((l.skew[0] = i.skew[0] * t), (l.skew[1] = i.skew[1] * t))
                },
            ...
            R = function (t) {
              var e = G(t.startPosition, 0),
                ...
                o = G(t.springConstant, 0.8),
                a = G(t.springDeceleration, 0.9),
                r = G(t.springMass, 10),
                s = !1
              return {
                tick: function (t) {
                  if (0 !== t && !s) {
                    ...
                    ;(n += u),
                      (e += n),
                      (n *= a),
                      Math.abs(e - i) < 0.001 && Math.abs(n) < 0.001 && (s = !0)
                  }
                },
            ...
            T = { linear: E, ease: A, easeIn: P, easeOut: M },
            I = function (t, e) {
            ...
            F = function () {
              ...
              return (
                N(t),
                {
                  ...
                  scale: function (n, o) {
                    return H(t, e), U(i, n, o), W(e, i, t), this
                  },
                  skew: function (n, o) {
              ...
              return {
                ...
                asMatrix: function () {
                  ...
                  return (
                    ...
                    this.rotation &&
                      (t.rotateX(this.rotation[0]),
                      t.rotateY(this.rotation[1]),
                      t.rotateZ(this.rotation[2])),
                    this.position &&
                      t.translate(this.position[0], this.position[1], this.position[2]),
                    this.rotationPost &&
                      (t.rotateX(this.rotationPost[0]),
                      t.rotateY(this.rotationPost[1]),
                      t.rotateZ(this.rotationPost[2])),
              ...
              return {
                tween: function (t) {
                  if (s) {
                    ...
                    ;(r.position[0] = o.position[0] + t * e),
                      (r.position[1] = o.position[1] + t * i),
                      (r.position[2] = o.position[2] + t * n)
                  }
                  if (h) {
                    var _ = a.rotation[0] - o.rotation[0],
                      m = a.rotation[1] - o.rotation[1],
                      g = a.rotation[2] - o.rotation[2]
                    ;(r.rotation[0] = o.rotation[0] + t * _),
                      (r.rotation[1] = o.rotation[1] + t * m),
                      (r.rotation[2] = o.rotation[2] + t * g)
                  }
                  if (u) {
                    var v = a.rotationPost[0] - o.rotationPost[0],
                      y = a.rotationPost[1] - o.rotationPost[1],
                      w = a.rotationPost[2] - o.rotationPost[2]
                    ;(r.rotationPost[0] = o.rotationPost[0] + t * v),
                      (r.rotationPost[1] = o.rotationPost[1] + t * y),
                      (r.rotationPost[2] = o.rotationPost[2] + t * w)
                  }
                  if (p) {
            ...
            V = function (t, i, n, o) {
              ...
              return {
                tween: function (i) {
                  ...
                  s.width !== e && (h.width = r.width + i * n),
                    s.height !== e && (h.height = r.height + i * o),
                    s.opacity !== e && (h.opacity = r.opacity + i * l)
                },
                asMatrix: function () {
                  return a
                },
        ...
        l = (function () {
          ...
          function i(t, e, i, r, s, h) {
            var u,
              ...
              N = new n(),
              H = N
            for (p = 1; p < O; p++) if (((H = H.next = new n()), p == B)) var F = H
            H.next = N
            var W = null,
              j = null
            _ = f = 0
          ...
          var o = [
            ...
            a = [
              ...
              18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19,
              19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21,
      ...
      var m = function () {
        ...
        v = function () {
          return (
            null === g && (g = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream), g
          )
        },
        y = function (t) {
          ...
          if ('undefined' == typeof t.dataset) {
            ...
            for (e in o)
              o.hasOwnProperty(e) &&
                ...
                ((i = b(o[e].name.substr(5))), (n[i] = o[e].value))
            return n
          }
          return t.dataset
        },
        ...
        k = function (t) {
          for (
            var e = [], i = Array.prototype.slice.call(t.attributes), n = i.length, o = 0;
            o < n;
            o++
          )
        ...
        H = function (t) {
          ...
          a &&
            h.upload.addEventListener('progress', function (t) {
              a(t.loaded, t.total)
            }),
            h.open(i, t, !0),
            o && o(h, n),
        ...
        j = function () {
          var t = [],
            e = void 0,
            i = void 0
          for (e in A) A.hasOwnProperty(e) && ((i = A[e]), t.indexOf(i) == -1 && t.push(i))
          return t
        },
        q = function (t) {
          return 'image/jpeg' === t
        ...
        G = function (t) {
          var e = void 0
          for (e in A) if (A.hasOwnProperty(e) && t.indexOf(A[e]) !== -1) return A[e]
          return null
        },
        X = function (t) {
        ...
        $ = function (t) {
          return 'undefined' == typeof t.name ? J(new Date()) + '.' + V(Q(t)) : t.name
        },
        Q = function (t) {
        ...
        K = function (t, e) {
          ...
          return (
            (i.name = e), (i.lastModified = Date.now()), (i.lastModifiedDate = i.lastModified), i
          )
        },
        tt = function (t) {
          return /^data:image/.test(t)
        },
        et = function (t, e, i, n, o, a) {
          ...
          r.open('GET', t, !0),
            ...
            (r.responseType = 'json'),
            (r.onload = function () {
              return 'failure' === this.response.status
                ? void o(this.response.message)
                : void it(this.response.body, i, a)
            }),
            r.send()
        },
        it = function (t, e, i, n) {
          ...
          o.open('GET', t, !0),
            ...
            (o.onload = function (e) {
              if (
                ...
                (0 === o.status && this.response instanceof Blob)
              ) {
                var a = X(t),
        ...
        ot = function (t, e) {
          for (
            var i = nt(t), n = new ArrayBuffer(i.length), o = new Uint8Array(n), a = 0;
            a < i.length;
            a++
          )
            o[a] = i.charCodeAt(a)
        ...
        rt = function (t, e, i) {
          ...
          n.parseMetaData(t, function (a) {
            ...
            e && ((r.maxWidth = e.width), (r.maxHeight = e.height)),
              a.exif && m() && (r.orientation = a.exif.get('Orientation')),
              n(
                t,
                function (t) {
        ...
        ht = function (t) {
          ...
          if (s) {
            ...
            s.x < 0 && (s.x = 0),
              s.y < 0 && (s.y = 0),
              s.width > c.width && (s.width = c.width),
              s.height > c.height && (s.height = c.height),
              s.y + s.height > c.height && (s.y = Math.max(0, c.height - s.height)),
              s.x + s.width > c.width && (s.x = Math.max(0, c.width - s.width))
            var d = s.x / c.width,
              f = s.y / c.height,
              _ = s.width / c.width,
              m = s.height / c.height
            ...
            90 === r
              ? (g.translate(0.5 * a.width, 0.5 * a.height),
                g.rotate((-90 * Math.PI) / 180),
                g.drawImage(
                  t,
                  (1 - f) * t.width - t.width * m,
                  s.x,
                  s.height,
                  s.width,
                  0.5 * -a.height,
              ...
              : g.drawImage(t, s.x, s.y, s.width, s.height, 0, 0, a.width, a.height)
          }
          if (h) {
        ...
        ct = function (t) {
          return function (e, i, n) {
            for (
              ...
              for (p = i; p--; ) {
                for (
                  var c = l, d = p, f = 4 * (l * i + p), _ = 0, m = 0, g = 0, v = 0, y = 0;
                  y < a;
                  y++
                )
                  for (var w = 0; w < a; w++) {
          ...
          return (
            ...
            e > 0 &&
              ...
              i(
                n,
                e,
                { width: Math.round(t.width * e), height: Math.round(t.height * e) },
                { width: 0, height: 0 },
              ),
            n
          )
        ...
        kt = function (t) {
          return 'object' === ('undefined' == typeof value ? 'undefined' : c(value)) &&
            null !== value
        ...
        Ct = function (t, i, n) {
          ...
          return (
            ...
            o.toDataURL(i, q(i) && 'number' == typeof n ? n / 100 : e)
          )
        },
        Et = function (t) {
          if (!t) return null
        ...
        At = function (t) {
          ...
          return (
            N('input', i) && !a && (r.input.image = Ct(t.input.image, t.input.type)),
            N('output', i) &&
              ((r.output = {
                name: o ? Z(t.input.name) + '.' + o : t.input.name,
                type: A[o] || t.input.type,
                width: t.output.width,
                height: t.output.height,
              }),
              (r.output.image = Ct(t.output.image, r.output.type, n)),
              (r.output.type = Et(r.output.image)),
              'image/png' === r.output.type && (r.output.name = Z(r.input.name) + '.png')),
            N('actions', i) && (r.actions = kt(t.actions)),
            r
          )
        },
        Pt = function (t, i, n) {
          var o = t.output.image,
            a = n ? Z(t.input.name) + '.' + n : t.input.name,
            r = A[n] || t.input.type
          'image/png' === r && (a = Z(t.input.name) + '.png'),
            o.toBlob(
              function (t) {
        ...
        Dt = (function () {
          var i = {
            ...
            w: function n(t, e, i, o) {
              ...
              return (
                (r = t.x + t.width),
                (h = U(e.x, 0, r)),
                r - h < i.min.width && (h = r - i.min.width),
                (u = o ? (r - h) * o : t.height),
                u < i.min.height && ((u = i.min.height), (h = r - u / o)),
                (l = 0.5 * (u - t.height)),
                (a = t.y - l),
                (s = t.y + t.height + l),
                (a < 0 || Math.round(s) > Math.round(i.height)) &&
                  ((p = Math.min(t.y, i.height - (t.y + t.height))),
                  (a = t.y - p),
                  (s = t.y + t.height + p),
                  (u = s - a),
            ...
            ne: function (t, e, i, n) {
              ...
              return (
                ...
                (a = U(e.x, s, i.width)),
                a - s < i.min.width && (a = s + i.min.width),
                (u = n ? (a - s) * n : U(r - e.y, i.min.height, r)),
                u < i.min.height && ((u = i.min.height), (a = s + u / n)),
                (o = t.y - (u - t.height)),
                (o < 0 || Math.round(r) > Math.round(i.height)) &&
            ...
            se: function (t, e, i, n) {
              ...
              return (
                ...
                (a = U(e.x, s, i.width)),
                a - s < i.min.width && (a = s + i.min.width),
                (u = n ? (a - s) * n : U(e.y - t.y, i.min.height, i.height - o)),
                u < i.min.height && ((u = i.min.height), (a = s + u / n)),
          ...
          return (function () {
            function n() {
              var i =
                arguments.length > 0 && arguments[0] !== e
                  ? arguments[0]
              ...
              p(n, [
                ...
                },
                {
                  ...
                  value: function (t, e, i, n) {
                    ;(this._interaction = null),
                      (this._rect = {
                        x: U(t, 0, this._space.width - this._minWidth),
                        y: U(e, 0, this._space.height - this._minHeight),
                        width: U(i, this._minWidth, this._space.width),
                        height: U(n, this._minHeight, this._space.height),
                      }),
                      (this._rectChanged = !0),
                      this._redraw(),
                      this._element.dispatchEvent(new CustomEvent('change'))
                ...
                },
                {
                  ...
                  value: function (t) {
                    this._element.contains(t.target) &&
                      (t.preventDefault(),
                      R(document, E.MOVE, this),
                      R(document, E.UP, this),
                      (this._interaction = { type: t.target.className, offset: O(t) }),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    'c' === n
                      ? ((this._rect.x = U(
                          e.x - this._interaction.offset.x,
                          0,
                          this._space.width - this._rect.width,
                        )),
                        (this._rect.y = U(
                          e.y - this._interaction.offset.y,
                          0,
                      ...
                      : i[n] &&
                        (this._rect = i[n](
                          this._rect,
                          { x: e.x - this._space.x, y: e.y - this._space.y },
                          {
                            x: 0,
                            y: 0,
                ...
                },
                {
                  ...
                  value: function (t) {
                    t.preventDefault(),
                      T(document, E.MOVE, this),
                      T(document, E.UP, this),
                      (this._interaction = null),
                ...
                p(
                  ...
                  [
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        t.scale(this._wrapperScale, this._wrapperScale),
                          ...
                          u.setElementTransform(this._previewWrapper, t)
                      },
                    },
                    {
                      key: '_onGridInput',
                        ...
                        if (!this._rotating) {
                          ...
                          this._element.dispatchEvent(
                            new CustomEvent('confirm', {
                              detail: { rotation: this._wrapperRotation % 360, crop: i },
                            }),
                          )
                        }
                      },
                    },
                    {
                      ...
                      value: function () {
                        ...
                        if (!this._rotating) {
                          ...
                          var e =
                            1 === this.ratio || null === this._ratio ? this._cropper.area : null
                          e && L(e, 90),
                            this._updateWrapperScale(),
                            this._hideCropper(),
                      ...
                      value: function (t) {
                        ...
                        ;(this._stage.style.cssText =
                          ...
                          this._cropper.offset(
                            u + this._element.offsetLeft,
                            l + this._element.offsetTop,
                          ),
                      ...
                      value: function () {
                        ...
                        ;(this._wrapper.style.cssText =
                          ...
                          this._blurredPreview ||
                            ...
                            mt(this._input, this._previewBlurred),
                            gt(this._previewBlurred, 3),
                    ...
                    },
                    {
                      ...
                      value: function () {
                        var t =
                          arguments.length > 0 && arguments[0] !== e ? arguments[0] : function () {}
                      ...
                      value: function () {
                        ...
                        Rt(this._btnGroup.children).forEach(function (e) {
                          ...
                          this._previewBlurred &&
                            ((this._previewBlurred.width = 1), (this._previewBlurred.height = 1)),
            ...
            return (
              p(n, [
                  ...
                  value: function (t) {
                    ...
                    if (this._allowURLs) {
                      var i = void 0,
                        n = void 0
                      try {
                        ;(i = t.dataTransfer.getData('url')),
                          (n = t.dataTransfer.getData('text/html'))
                      } catch (t) {}
                      if (n && n.length) {
                    ...
                    this._element.dispatchEvent(new CustomEvent('file-drop', { detail: x(t) })),
                      this._element.dispatchEvent(new CustomEvent('change')),
                      (this._dragPath = null)
                  },
                },
                  ...
                  value: function (t) {
                    ...
                    return null === e || e
                      ? (this._dragPath || (this._dragPath = []),
                        this._dragPath.push(x(t)),
                        void this._element.dispatchEvent(
                          new CustomEvent('file-over', {
                            detail: { x: B(this._dragPath).x, y: B(this._dragPath).y },
                          }),
                        ))
                ...
                },
                {
                  key: '_onDragLeave',
                  value: function (t) {
                    this._element.dispatchEvent(new CustomEvent('file-out', { detail: x(t) })),
                      (this._dragPath = null)
                  },
                },
                {
        ...
        Wt = { AUTO: 'auto', INITIAL: 'initial', MANUAL: 'manual' },
        jt = ['x', 'y', 'width', 'height'],
        ...
        Kt = (function () {
          function i(n) {
            ...
            t(this, i),
              Xt || (Xt = new Nt()),
              (this._uid = Yt++),
              (this._options = S(i.options(), o)),
              this._options.forceSize &&
                ('string' == typeof this._options.forceSize &&
                  (this._options.forceSize = Qt(this._options.forceSize)),
                (this._options.ratio =
                  this._options.forceSize.width + ':' + this._options.forceSize.height),
                (this._options.size = kt(this._options.forceSize))),
              'string' == typeof this._options.size &&
                (this._options.size = Qt(this._options.size)),
              'string' == typeof this._options.minSize &&
                (this._options.minSize = Qt(this._options.minSize)),
              'string' == typeof this._options.post &&
                (this._options.post = this._options.post.split(',').map(function (t) {
                  return t.trim()
                })),
              (this._originalElement = n),
              (this._originalElementInner = n.innerHTML),
              (this._originalElementAttributes = k(n)),
              Ft(n)
                ? (this._element = n)
                : ((this._element = It(n)),
                  (this._element.className = n.className),
                  (n.className = ''),
            ...
            p(
              ...
              [
                  ...
                  value: function (t, e) {
                    if ('number' == typeof t || t % 90 === 0) {
                      ...
                      if (this._data.input.image) {
                        ...
                        ;(this._data.actions.crop = st(n, o, this._ratio)),
                          (this._data.actions.crop.type = Wt.AUTO)
                      }
                ...
                },
                {
                  key: 'setSize',
                  value: function (t, e) {
                    'string' == typeof t && (t = Qt(t)),
                      t &&
                        t.width &&
                        t.height &&
                        ((this._options.size = kt(t)),
                        (this._data.actions.size = kt(t)),
                        this._data.input.image && e && this._manualTransform(e))
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    if (
                      t &&
                      'string' == typeof t &&
                      ((this._options.ratio = t), this._isFixedRatio())
                    ) {
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    'function' == typeof i
                      ? (n = i)
                      : ((this._options.crop = i.crop),
                        (this._options.rotation = i.rotation),
                        (this._initialRotation =
                          i.rotation && i.rotation % 90 === 0 ? i.rotation : null),
                        (this._initialCrop = this._options.crop)),
                      this._load(t, n, { blockPush: i.blockPush })
                  },
                },
                {
                  key: 'upload',
                ...
                },
                {
                  key: '_addState',
                  value: function (t) {
                    N(t, this._state) || (this._state.push(t), this._updateState())
                  },
                },
                {
                  key: '_updateState',
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    r
                      ? (this._hasInitialImage = !0)
                      : ((this._initialCrop = null), (this._initialRotation = null))
                    var h =
                    ...
                    if (this._isImageOnly())
                      ...
                      'image/*' !== this._input.getAttribute('accept')
                        ...
                        : ((u = j()), this._input.setAttribute('accept', u.join(','))),
                        (this._imageHopper = new Ut()),
                  ...
                  value: function () {
                    ...
                    var e = function () {
                      var e = setTimeout(function () {
                        Zt(t._timers, e), t._options.didInit.apply(t, [t.data, t])
                      }, 0)
                      t._timers.push(e)
                    }
                  ...
                  value: function (t) {
                    if (((t = Math.min(0.99999, t)), this._element && this._progressEnabled)) {
                      ...
                      if (e) {
                        ...
                        0.5 * i < o ||
                          (n[0].setAttribute('d', zt(0.5 * i, 0.5 * i, 0.5 * i - o, 0.9999)),
                          n[1].setAttribute('d', zt(0.5 * i, 0.5 * i, 0.5 * i - o, t)))
                      }
                    }
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    return (
                      this._drip || (this._drip = this._element.querySelector('.slim-drip > span')),
                      this._drip
                    )
                  },
                },
                {
                  ...
                  value: function (t) {
                    ...
                    e ||
                      ((e = M('div', 'slim-error')),
                      this._element.querySelector('.slim-status').appendChild(e)),
                      (e.innerHTML = t),
                ...
                },
                {
                  ...
                  value: function (t, i) {
                    ...
                    if (!this._isBeingDestroyed) {
                      ...
                      var a = function () {
                          clearTimeout(n._loadTimeout),
                            (n._loadTimeout = setTimeout(function () {
                              n._isBeingDestroyed ||
                                (n._addState('loading'),
                                u(n._element.querySelector('.slim-label-loading'), {
                                  fromOpacity: 0,
                                  opacity: 1,
                                  duration: 250,
                                }))
                        ...
                        r = function () {
                          n._imageHopper && (n._imageHopper.enabled = !0),
                      ...
                      if ('undefined' != typeof t.remote)
                        return tt(t.remote)
                          ? void this._load(ot(t.remote), i, o)
                          : void (
                      ...
                      if (this._imageHopper && this._imageHopper.accept.indexOf(s.type) === -1)
                        return (
                          r(), this._onInvalidFile(), void (i && i.apply(this, ['file-invalid']))
                        )
                      if (
                        s.size &&
                        this._options.maxFileSize &&
                        W(s.size) > this._options.maxFileSize
                      )
                        return (
                          r(), this._onOverWeightFile(), void (i && i.apply(this, ['file-too-big']))
                        )
                      this._imageEditor && this._imageEditor.dirty(),
                        (this._data.input.name = o && o.name ? o.name : $(s)),
                        (this._data.input.type = Q(s)),
                        (this._data.input.size = s.size),
                        (this._data.input.file = s)
                      var h = this._options.internalCanvasSize
                      v() && (h = this._options.internalCanvasSizeLowMemory),
                        rt(s, h, function (t, e) {
                          var a = function () {
                            n._imageHopper && (n._imageHopper.enabled = !0),
                              n._removeState('loading'),
                          ...
                          if (!vt(t, n._options.minSize))
                            return (
                              a(), n._onImageTooSmall(), void (i && i.apply(n, ['image-too-small']))
                            )
                          var r = n._options.didLoad.apply(n, [s, t, e, n])
                          if (r !== !0)
                            return a(), r !== !1 && n._throwError(r), void (i && i.apply(n, [r]))
                          n._removeState('loading')
                          var h = function (t) {
                            n._imageHopper &&
                              n._options.dropReplace &&
                              (n._imageHopper.enabled = !0)
                            var e = n._getIntro(),
                              i = {
                                fromScale: [1.25, 1.25],
                                scale: [1, 1],
                            ...
                            n.isDetached()
                              ? (i.duration = 1)
                              : ((i.easing = 'spring'),
                                (i.springConstant = 0.3),
                                (i.springDeceleration = 0.7)),
                              n._canInstantEdit() &&
                                ((i.delay = 500), (i.duration = 1), n._doEdit()),
                              u(e, i)
                          }
                          n._options.willLoadCanvas.apply(n, [
                            t,
                            function (t) {
                              n._loadCanvas(
                                t,
                                function (t) {
                                  n._addState('preview'),
                                    h(function () {
                                      n._canInstantEdit() || t || n._showButtons(),
                                        t || (n._stopProgressLoop(), n._removeState('busy')),
                                        i && i.apply(n, [null, n.data])
                                    })
                                },
                                function () {
                    ...
                    if ((n || (n = {}), !this._isBeingDestroyed)) {
                      v()
                        ? ((this._data.input.image = new Image()),
                          (this._data.input.image.src = t.toDataURL()))
                      ...
                      this._initialCrop
                        ? ((this._data.actions.crop = kt(this._initialCrop)),
                          (this._data.actions.crop.type = Wt.INITIAL),
                        ...
                        : this._options.willCropInitial.apply(this, [
                            ...
                            function (e) {
                              e
                                ? ((o._data.actions.crop = e),
                                  (o._data.actions.crop.type = Wt.INITIAL))
                                : ((o._data.actions.crop = st(
                                    a ? t.height : t.width,
                                    a ? t.width : t.height,
                                    o._ratio,
                                  )),
                                  (o._data.actions.crop.type = Wt.AUTO)),
                                r()
                            },
                            this,
                          ])
                  ...
                  value: function (t, e) {
                    ...
                    ;(n.filters = { sharpen: this._options.filterSharpen / 100 }),
                      ...
                      ht(t, n, function (t) {
                        var n = t
                        if (
                          i._options.forceSize ||
                          (i._options.size && 1 == dt(i._options.size, t))
                        ) {
                          ;(n = M('canvas')),
                            (n.width = i._options.size.width),
                            (n.height = i._options.size.height)
                          var o = n.getContext('2d')
                        ...
                        if (
                          ...
                          (n.width < i._options.minSize.width ||
                            n.height < i._options.minSize.height)
                        ) {
                        ...
                        ;(i._data.output.width = n.width),
                          ...
                          i._onTransformCanvas(function (t) {
                            ;(i._data = t),
                              i._options.didTransform.apply(i, [i.data, i]),
                              e(i._data.output.image)
                          })
                      })
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    var t = this
                    this._imageEditor ||
                      ((this._imageEditor = new Bt(M('div'), {
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    e &&
                      this._element &&
                      ((e.style.marginBottom = 100 * t + '%'),
                      this._element.setAttribute('data-ratio', '1:' + t))
                  },
                },
                {
                  key: '_onCancel',
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    i
                      ...
                      (this._data.actions.crop.type = Wt.MANUAL),
                      this._applyTransforms(this._data.input.image, function (t) {
                        ...
                        ;(o.className = 'in'),
                          ...
                          (a.style.zIndex = '1')
                        var r =
                            'auto' === e._options.devicePixelRatio
                              ? window.devicePixelRatio
                              : e._options.devicePixelRatio,
                          ...
                          (o.onload = function () {
                            ;(o.onload = null),
                              'free' === e._options.ratio &&
                                ((e._ratio = o.naturalHeight / o.naturalWidth),
                ...
                },
                {
                  ...
                  value: function () {
                    var t =
                        arguments.length > 0 && arguments[0] !== e ? arguments[0] : function (t) {},
                      i = this._data.actions.rotation % 180 !== 0,
                      n = st(
                        i ? this._data.input.image.height : this._data.input.image.width,
                        i ? this._data.input.image.width : this._data.input.image.height,
                        this._ratio,
                      )
                ...
                },
                {
                  ...
                  value: function (t, i, n, o) {
                    var a =
                        arguments.length > 4 && arguments[4] !== e ? arguments[4] : function (t) {},
                      r = arguments.length > 5 && arguments[5] !== e ? arguments[5] : Wt.MANUAL
                    ;(this._output.value = ''),
                      (this._data.actions.crop = { x: t, y: i, width: n, height: o }),
                      (this._data.actions.crop.type = r),
                      this._manualTransform(a)
                  },
                },
                {
                          ...
                          (this._options.service &&
                            ...
                            this._options.willSave.apply(this, [
                              ...
                              function (e) {
                                t._addState('upload'),
                                  t._imageHopper &&
                                    t._options.dropReplace &&
                                    (t._imageHopper.enabled = !1),
                                  t._upload(e, function (n, o) {
                                    t._imageHopper &&
                                      t._options.dropReplace &&
                                      (t._imageHopper.enabled = !0),
                                      n || t._storeServerResponse(o),
                                      t._options.didUpload.apply(t, [n, e, o, t]),
                ...
                },
                {
                  ...
                  value: function (t) {
                    this._isRequired && (this._input.required = !1),
                      (this._output.value = JSON.stringify(t))
                  },
                },
                {
                  key: '_upload',
                  value: function (t, e) {
                    ...
                    this.requestOutput(function (t, n) {
                        ...
                        h = function (t) {
                          ...
                          n =
                            'file-too-big' === t
                              ...
                              : i._options.didReceiveServerError.apply(i, [
                                  t,
                                  i._options.statusUnknownResponse,
                                  i,
                                ])
                      ...
                      'string' == typeof i._options.service
                        ? H(i._options.service, i._options.uploadMethod, n, a, r, s, h)
                        : 'function' == typeof i._options.service &&
                          i._options.service.apply(i, [
                            'file' === i._options.serviceFormat ? t : n,
                            r,
                            s,
                            h,
                            i,
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    return this._data.input.file
                      ? (e || (e = this.dataBase64),
                        void n.parseMetaData(
                          this._data.input.file,
                          function (o) {
                            var a = [],
                              r = new FormData()
                            if (
                              (N('input', i._options.post) &&
                                (a.push(i._data.input.file),
                                r.append(
                                  i._inputReference,
                                  i._data.input.file,
                                  i._data.input.file.name,
                                )),
                              N('output', i._options.post) &&
                                null !== i._data.output.image &&
                                i._options.uploadBase64 === !1)
                            ) {
                              var s = ot(e.output.image, e.output.name)
                              if (o.imageHead && i._options.copyImageHead)
                                try {
                ...
                },
                {
                  key: '_showEditor',
                  value: function () {
                    ;(Xt.className = this._options.popoverClassName),
                      Xt.show(),
                  ...
                  value: function (t) {
                    ...
                    if (this._btnGroup) {
                      ...
                      this.isDetached()
                        ...
                        : ((i.easing = 'spring'),
                          (i.springConstant = 0.3),
                          (i.springDeceleration = 0.75)),
                        u(this._btnGroup.childNodes, i)
                    }
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this._data.input.image &&
                      ...
                      (Xt.inner = this._imageEditor.element),
                  ...
                  value: function () {
                    ...
                    ;(this._isBeingDestroyed = !0),
                      ...
                      this._imageEditor &&
                        ...
                        (this._imageEditor = null)),
                      Rt(this._btnGroup.children).forEach(function (t) {
      ...
      return (
        (function () {
          ...
          ;['FileSize', 'FileType', 'NoSupport', 'ImageTooSmall'].forEach(function (t) {
            ...
            ['ContentLength', 'UnknownResponse', 'UploadSuccess', 'LocalUrlProblem'].forEach(
              function (t) {
                d['status' + t] = o
              },
            ),
            ...
            (Kt.getOptionsFromAttributes = function (t) {
              ...
              for (var n in e) {
                var o = d[n],
                  a = e[n]
                o
                  ? ((a = o(a)), (a = null === a ? kt(Kt.options()[n]) : a), (i[n] = a))
                  : 0 === n.indexOf('meta') && (i.meta[z(n.substr(4))] = a)
              }
              return i
            }),
            (Kt.find = function (t) {
        ...
        default:
          ...
          return (
            this.each(function () {
              ...
              i &&
                (r(i, e)
                  ? h.push(i[e].apply(i, t))
                  : o(i, e)
                  ? h.push(i[e])
                  : a(i, e) && h.push((i[e] = t[0])))
            }),
            h
          )
      }
