...
const cancelar = async () => {
  if (sNegocio.negocio.codnegociostatus != 1 && sNegocio.negocio.codnegociostatus != 2) {
    return
  }
  Dialog.create({
...
const romaneioOuNota = async () => {
  ...
  // busca natureza
  const nat = await db.naturezaOperacao.get(sNegocio.negocio.codnaturezaoperacao)
  ...
  <q-page v-if="sNegocio.negocio">
    ...
    <q-dialog v-model="sNegocio.dialogVerificarDuplicados">
      <q-card style="width: 500px; max-width: 90vw">
        ...
        <q-card-section>
          <div v-if="sNegocio.gruposDuplicadosPorBarras.length === 0" class="text-grey-7">
            ...
            >
              <q-item-section>
                ...
                <q-list dense class="q-mt-xs">
                  <q-item v-for="it in grupo.itens" :key="it.uuid" class="q-px-none">
                    <q-item-section>
                      <q-item-label caption>
                        Qtd: {{ it.quantidade }} ×
                ...
                <div v-if="!grupo.podeJuntar" class="text-negative text-caption q-mt-xs">
                  Divergente em: {{ grupo.camposDivergentes.join(', ') }} — ajuste manualmente.
                </div>
              </q-item-section>
      ...
      <div class="q-gutter-sm">
        ...
        <q-fab color="accent" icon="print" direction="up" v-if="sNegocio.itensAtivos.length > 0">
          ...
          <q-fab-action
            ...
            color="accent"
            @click="comanda()"
            v-if="sNegocio.negocio.sincronizado > 0 && sNegocio.negocio.codnegociostatus == 1"
          />
