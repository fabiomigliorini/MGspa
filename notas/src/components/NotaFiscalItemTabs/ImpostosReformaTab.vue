...
<template>
  ...
  <q-card>
    <q-card-section class="text-subtitle1 text-weight-bold q-my-md bg-primary text-white q-pa-sm">
        ...
        <q-card flat bordered>
          <q-card-section class="text-center">
            ...
            <div class="text-h6 text-positive">
              ...
              {{
                tributos
                  .filter((t) => t.geracredito)
                  .reduce((acc, t) => acc + (t.valorcredito || 0), 0)
                  .toFixed(2)
              }}
            </div>
          </q-card-section>
      ...
      <q-card flat bordered class="q-my-md">
        <q-card-section>
          ...
          <div class="text-subtitle1 text-weight-bold">
            <q-icon
              v-if="tributoItem.tributo?.ente"
              :name="getEnteIcon(tributoItem.tributo?.ente)"
              size="sm"
          ...
          <div class="row q-col-gutter-md">
            ...
            <div class="col-6">
              <div style="height: 56px; display: flex; align-items: center">
                <q-toggle
                  v-model="tributoItem.geracredito"
    ...
    <q-card flat bordered class="q-my-md">
      ...
      <q-card-section>
        <div class="row q-col-gutter-md">
          ...
          <div class="col-6">
            <q-btn color="primary" @click="add()" icon="add">Adicionar</q-btn>
          </div>
        </div>
      </q-card-section>
    </q-card>
