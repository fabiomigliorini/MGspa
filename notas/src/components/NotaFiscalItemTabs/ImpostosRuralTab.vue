  ...
  <q-card class="q-mt-md">
    ...
    <q-card-section class="q-pa-sm">
      <div class="row q-col-gutter-md">
        ...
        <div class="col-6 col-sm-3">
          <MgInputValor
            v-model="editingItem.fethabvalor"
            label="Valor FETHAB"
            :min="0"
            prefix="R$"
            :readonly="notaBloqueada"
  ...
  <q-card class="q-mt-md">
    ...
    <q-card-section class="q-pa-sm">
      <div class="row q-col-gutter-md">
        ...
        <div class="col-6 col-sm-3">
          <MgInputValor
            v-model="editingItem.iagrovalor"
            label="Valor IAGRO"
            :min="0"
            prefix="R$"
            :readonly="notaBloqueada"
  ...
  <q-card class="q-mt-md">
    ...
    <q-card-section class="q-pa-sm">
      <div class="row q-col-gutter-md">
        <div class="col-6 col-sm-3">
          <MgInputValor
            v-model="editingItem.funruralpercentual"
            label="Alíquota"
            :min="0"
            :max="100"
            suffix="%"
        ...
        <div class="col-6 col-sm-3">
          <MgInputValor
            v-model="editingItem.funruralvalor"
  ...
  <q-card class="q-mt-md">
    ...
    <q-card-section class="q-pa-sm">
      <div class="row q-col-gutter-md">
        <div class="col-6 col-sm-3">
          <MgInputValor
            v-model="editingItem.senarpercentual"
            label="Alíquota"
            :min="0"
            :max="100"
            suffix="%"
        ...
        <div class="col-6 col-sm-3">
          <MgInputValor
            v-model="editingItem.senarvalor"
            label="Valor SENAR"
            :min="0"
            prefix="R$"
            :readonly="notaBloqueada"
