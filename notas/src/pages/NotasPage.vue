...
// Inutilizacao de lacunas mora em /inutilizacao (InutilizacaoPage), que e a casa do assunto:
// la da para inutilizar faixa manualmente e ver o historico, alem de detectar lacunas.
