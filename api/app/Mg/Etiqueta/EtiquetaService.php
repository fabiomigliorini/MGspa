...
class EtiquetaService
{
    ...
    public static function imprimir($impressora, $modelo, $etiquetas)
    {
        ...
        $cmd = 'curl -X POST https://rest.ably.io/channels/printing/messages -u "' . env('ABLY_APP_KEY') . '" -H "Content-Type: application/json" --data \'{ "name": "' . $impressora . '", "data": "{\"url\": \"' . $url . '\", \"method\": \"get\", \"options\": [\"raw\"], \"copies\": 1}" }\'';
        exec($cmd);
