    ...
    public static function distribuirSaldoDeposito(Marca $marca)
    {
        ...
        foreach ($prods as $i_prod => $prod) {
            ...
            if ($saldo_total > $maximo_total) {
                ...
                $percentuais = VendaMensalService::determinarPercentualEstoqueLocal($saldo_total);
                $maximos = VendaMensalService::ratearQuantidadePelosPercentuais($saldo_total, $percentuais);
