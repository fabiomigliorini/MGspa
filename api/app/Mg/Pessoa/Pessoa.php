...
class Pessoa extends MgModel
{
    ...
    // Cartoes (Beneficio/Corporativo) da pessoa — colaborador ou filial.
    public function PessoaCartaoS()
    {
        return $this->hasMany(PessoaCartao::class, 'codpessoa', 'codpessoa');
    }
    ...
    {
        return $this->hasMany(MetaUnidadeNegocioPessoaFixo::class, 'codpessoa', 'codpessoa');
    }
    ...
    {
        return $this->hasMany(ValeModelo::class, 'codpessoafavorecido', 'codpessoa');
    }
