...
class PedidoService extends MgService
{
    ...
    public static function insert(array $data): Pedido
    {
    ...
    public static function update(Pedido $model, array $data): Pedido
    {
        $model->fill($data);
    ...
    public static function delete(Pedido $model): Pedido
    {
        $sql = "
